...
class HOTEL_MANGMENT_checkin:
    def __init__(self):
        ...
        def chk_add():
            while True:
                ...
                if len(self.g)!= 0 and ak!=True:
                    ...
                    self.Text1.insert(INSERT, "Valid Address has been inserted""\n")
                    break
                else:
        ...
        def chk_mo():
            while True:
                ...
                if self.h.isdigit() == True and len(self.h) != 0 and len(self.h) == 10:
                    self.MOBILE = self.h
                    self.Text1.insert(INSERT, "Valid Mobile Number has been inserted""\n")
                    break
                else:
        ...
        def chk_day():
            while True:
                ...
                if self.l.isdigit() == True and len(self.l) != 0:
                    ...
                    self.Text1.insert(INSERT, "Number of days given""\n")
                    break
                else:
        ...
        font11 = "-family {Times New Roman} -size 30 -weight bold -slant "  \
            "roman -underline 0 -overstrike 0"
        font12 = "-family {Times New Roman} -size 18 -weight bold -slant "  \
            "roman -underline 0 -overstrike 0"
        font13 = "-family {Times New Roman} -size 17 -weight bold -slant "  \
            "roman -underline 0 -overstrike 0"
        font14 = "-family {Times New Roman} -size 16 -weight bold -slant "  \
            "roman -underline 0 -overstrike 0"
        font15 = "-family {Times New Roman} -size 19 -weight bold -slant "  \
            "roman -underline 0 -overstrike 0"
        font16 = "-family {Times New Roman} -size 15 -weight bold -slant "  \
            "roman -underline 0 -overstrike 0"
        font9 = "-family {Times New Roman} -size 9 -weight normal -slant "  \
            "roman -underline 0 -overstrike 0"
        ...
        self.Text1.configure(background="#e75480")
        ...
        self.Frame1.configure(highlightbackground="#e75480")
        ...
        self.Message1.configure(background="#e75480")
        ...
        self.Message2.place(relx=0.52, rely=0.11, relheight=0.84, relwidth=0.05)
        self.Message2.configure(background="#e75480")
        ...
        self.Message3.configure(background="#e75480")
        ...
        self.Frame2.configure(highlightbackground="#e75480")
        ...
        self.Label3.configure(activebackground="#e75480")
        ...
        self.Label3.configure(foreground="#e75480")
        ...
        self.Label4.configure(activebackground="black")
        self.Label4.configure(activeforeground="#e75480")
        self.Label4.configure(background="black")
        self.Label4.configure(disabledforeground="#bfbfbf")
        self.Label4.configure(font=font12)
        self.Label4.configure(foreground="#e75480")
        ...
        self.Label5.configure(activebackground="black")
        self.Label5.configure(activeforeground="#e75480")
        self.Label5.configure(background="black")
        self.Label5.configure(disabledforeground="#bfbfbf")
        self.Label5.configure(font=font12)
        self.Label5.configure(foreground="#e75480")
        ...
        self.Label7.configure(activebackground="#e75480")
        self.Label7.configure(activeforeground="black")
        self.Label7.configure(background="black")
        ...
        self.Message4.configure(background="black")
        self.Message4.configure(font=font13)
        self.Message4.configure(foreground="#e75480")
        ...
        self.Message5.configure(background="black")
        self.Message5.configure(font=font13)
        self.Message5.configure(foreground="#e75480")
        ...
        self.Message6.configure(background="black")
        self.Message6.configure(font=font13)
        self.Message6.configure(foreground="#e75480")
        ...
        self.Checkbutton1.configure(activebackground="#e75480")
        ...
        self.Checkbutton1.configure(foreground="#e75480")
        self.Checkbutton1.configure(highlightbackground="#ffffff")
        self.Checkbutton1.configure(highlightcolor="#e75480")
        ...
        self.Checkbutton2.configure(activebackground="#e75480")
        self.Checkbutton2.configure(activeforeground="black")
        self.Checkbutton2.configure(background="black")
        self.Checkbutton2.configure(foreground="#e75480")
        self.Checkbutton2.configure(disabledforeground="#e75480")
        ...
        self.Checkbutton3.configure(activebackground="#e75480")
        self.Checkbutton3.configure(activeforeground="black")
        self.Checkbutton3.configure(background="black")
        self.Checkbutton3.configure(disabledforeground="#e75480")
        self.Checkbutton3.configure(font=font13)
        self.Checkbutton3.configure(foreground="#e75480")
        ...
        self.Checkbutton4.configure(activebackground="#e75480")
        self.Checkbutton4.configure(activeforeground="black")
        self.Checkbutton4.configure(background="black")
        self.Checkbutton4.configure(disabledforeground="black")
        self.Checkbutton4.configure(font=font13)
        self.Checkbutton4.configure(foreground="#e75480")
        ...
        self.Checkbutton5.configure(activebackground="#e75480")
        self.Checkbutton5.configure(activeforeground="black")
        self.Checkbutton5.configure(background="black")
        self.Checkbutton5.configure(disabledforeground="#e75480")
        self.Checkbutton5.configure(font=font16)
        self.Checkbutton5.configure(foreground="#e75480")
        self.Checkbutton5.configure(highlightbackground="#ffffff")
        self.Checkbutton5.configure(highlightcolor="#e75480")
        ...
        self.Checkbutton6.configure(activebackground="#e75480")
        self.Checkbutton6.configure(activeforeground="black")
        self.Checkbutton6.configure(background="black")
        self.Checkbutton6.configure(disabledforeground="black")
        self.Checkbutton6.configure(font=font16)
        self.Checkbutton6.configure(foreground="#e75480")
        ...
        self.Message7.configure(background="black")
        self.Message7.configure(font=font15)
        self.Message7.configure(foreground="#e75480")
        ...
        self.Button4.configure(background="#e75480")
        ...
        self.Label1.configure(foreground="#e75480")
        ...
        self.Message8.configure(background="black")
        self.Message8.configure(font=font13)
        self.Message8.configure(foreground="#e75480")
