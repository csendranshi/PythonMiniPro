...
class New_Toplevel:
    ...
    def __init__(self):
        ...
        font11 = "-family {Times New Roman} -size 23 -weight bold -slant "  \
            "roman -underline 0 -overstrike 0"
        font12 = "-family {Times new Roman} -size 24 -weight bold -slant "  \
            "roman -underline 0 -overstrike 0"
        ...
        self.Label1.configure(activebackground="#e75480")
        self.Label1.configure(activeforeground="black")
        self.Label1.configure(background="#e75480")
        ...
        self.Text1.place(relx=0.05, rely=0.54, relheight=1, relwidth=0.89)
        ...
        self.Button1.configure(activebackground="light blue")
        self.Button1.configure(activeforeground="#000000")
        self.Button1.configure(background="light blue")
