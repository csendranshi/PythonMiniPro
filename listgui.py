...
class HOTEL_MANGMENT_checkin:
    def __init__(self):
        ...
        font11 = "-family {Times New Roman} -size 17 -weight bold -slant "  \
        ...
        root.configure(highlightbackground="#FFFF99")
        ...
        self.Labelframe1.configure(text='''LIST OF ALL CHECKED IN CUSTOMERS''')
        self.Labelframe1.configure(background="#e75480")
        ...
        self.Frame1.configure(highlightbackground="#FFFF99")
        ...
        self.Label1.configure(disabledforeground="white")
